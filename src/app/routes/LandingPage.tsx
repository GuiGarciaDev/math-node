  ...
  ({ currentRoute, onRouteChange }) => {
    ...
    const launchWorkflow = useCallback(
      (payload: {
        ...
        onRouteChange("FlowCanvasPage")
      },
      [onRouteChange, openWorkflowSession],
    )

    const isActive = currentRoute === "landingPage"
          ...
          <div className="container relative z-20 mx-auto flex h-full items-center px-6 md:px-12">
            <div className="max-w-2xl">
              ...
              <p className="mb-10 text-xl leading-relaxed text-gray-300">
                Nodes is the most powerful way to operate. Connect every tool
